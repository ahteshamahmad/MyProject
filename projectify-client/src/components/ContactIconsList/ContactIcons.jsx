...
const MOCKDATA = [
    { title: 'Email', description: 'hello@nseit.com', icon: IconAt },
    { title: 'Phone', description: '+91 3353535353', icon: IconPhone },
    { title: 'Address', description: 'Chennai', icon: IconMapPin },
