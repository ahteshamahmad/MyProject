...
import { EMPLOYEE_DETAILS_EID_LINK } from '../../routes/route';

const EmployeeCard = ({ userEmployee }) => {
    const { image, firstName, middleName, lastName, designation, email, employee } = userEmployee
    return (
        <Paper
            withBorder
            radius="md"
        ...
        >
            <Stack justify="space-between" className='h-full'>
                ...
                <Button component={Link} to={EMPLOYEE_DETAILS_EID_LINK + employee?.employeeCode} fullWidth mt="md" radius="xl">
                    View Employee
                </Button>
            </Stack>
        </Paper>
